...
(function vodDownloader($, platform, Waves) {
  ...
  var Exception = function(error, templateParams) {
    this.error = error;
    this.templateParams = Array.isArray(templateParams)
      ? templateParams
      : [templateParams];
  };
  ...
  var Tool = (function(Tool) {
    ...
    Tool.downloadFile = function(fileUrl, title) {
      ...
      movieTitle = movieTitle.replace(
        new RegExp(config.windowsNotAllowedFileNameCharsMask),
        ""
      );
    ...
    Tool.getRealUrl = function() {
      var topUrl = window.sessionStorage.getItem(
        config.storage.topWindowLocation
      );
  ...
  const config = {
    ...
    include: {
      ...
      mdb: {
        id: "mdb",
        css:
          "https://cdnjs.cloudflare.com/ajax/libs/mdbootstrap/4.8.2/css/mdb.min.css"
      }
    },
    error: {
      id: {
    ...
    description: {
      ...
      sources: {
        IPLA: {
          "1080p": {
            video: "H264 MPEG-4 AVC, 4011 kb/s, 1920x1080, 25fps, 16:9",
            index: 1
          },
          "720p": {
            video: "H264 MPEG-4 AVC, 1672 kb/s, 1280x720, 25fps, 16:9",
            index: 2
          },
          "576p": {
            video: "H264 MPEG-4 AVC, 1175 kb/s, 1024x576, 25fps, 16:9",
            index: 3
          },
          "384p": {
            video: "H264 MPEG-4 AVC, 256 kb/s, 484x272, 25fps, 16:9",
            index: 4
          }
        },
        WP: {
          HQ: {
            video: "H264 MPEG-4 AVC, 1804 kb/s, 1280x720, 24fps, 16:9",
            index: 1
          },
          LQ: {
            video: "H264 MPEG-4 AVC, 616 kb/s, 640x360, 24fps, 16:9",
            index: 2
          }
        },
        TVN: {
          HD: {
            video: "H264 MPEG-4 AVC, 2776 kb/s, 1280x720, 25fps, 16:9",
            index: 1
          },
          "Bardzo wysoka": {
            video: "H264 MPEG-4 AVC, 1786 kb/s, 1280x720, 25fps, 16:9",
            index: 2
          },
          Wysoka: {
            video: "H264 MPEG-4 AVC, 1191 kb/s, 720x576, 25fps, 5:4",
            index: 3
          },
          Standard: {
            video: "H264 MPEG-4 AVC, 794 kb/s, 720x576, 25fps, 5:4",
            index: 4
          },
          Średnia: {
            video: "H264 MPEG-4 AVC, 596 kb/s, 640x480, 25fps, 4:3",
            index: 5
          },
          Niska: {
            video: "H264 MPEG-4 AVC, 417 kb/s, 512x384, 25fps, 4:3",
            index: 6
          },
          "Bardzo niska": {
            video: "H264 MPEG-4 AVC, 238 kb/s, 320x240, 25fps, 4:3",
            index: 7
          }
        },
        VOD: {
          "720": {
            video: "H264 MPEG-4 AVC, 2467 kb/s, 1280x720, 25fps, 16:9",
            index: 1
          },
          "576": {
            video: "H264 MPEG-4 AVC,1810 kb/s, 1024x576, 25fps, 16:9",
            index: 2
          },
          "480": {
            video: "H264 MPEG-4 AVC, 911 kb/s, 854x480, 25fps, 16:9",
            index: 3
          },
          "360": {
            video: "H264 MPEG-4 AVC, 450 kb/s, 640x360, 25fps, 16:9",
            index: 4
          },
          "240": {
            video: "H264 MPEG-4 AVC, 200 kb/s, 426x240, 25fps, 16:9",
            index: 5
          }
        },
        TVP: {
          "9100000": {
            video: "H264 MPEG-4 AVC, 21030 kb/s, 1920x1080, 25fps, 16:9",
            index: 1
          },
          "5420000": {
            video: "H264 MPEG-4 AVC, 9875 kb/s, 1280x720, 25fps, 16:9",
            index: 2
          },
          "2850000": {
            video: "H264 MPEG-4 AVC, 4661 kb/s, 960x540, 25fps, 16:9",
            index: 3
          },
          "1750000": {
            video: "H264 MPEG-4 AVC, 1782 kb/s, 800x450, 25fps, 16:9",
            index: 4
          },
          "1250000": {
            video: "H264 MPEG-4 AVC, 1255 kb/s, 640x360, 25fps, 16:9",
            index: 5
          },
          "820000": {
            video: "H264 MPEG-4 AVC, 809 kb/s, 480x270, 25fps, 16:9",
            index: 6
          },
          "590000": {
            video: "H264 MPEG-4 AVC, 581 kb/s, 398x224, 25fps, 199:112",
            index: 7
          }
        },
        ARTE: {
          "2200": {
            video: "H264 MPEG-4 AVC,  2438 kb/s, 1280x720, 25fps, 16:9",
            index: 1
          },
          "1500": {
            video: "H264 MPEG-4 AVC,  1619 kb/s, 720x406, 25fps, 360:203",
            index: 2
          },
          "800": {
            video: "H264 MPEG-4 AVC,  805 kb/s, 640x360, 25fps, 16:9",
            index: 3
          },
          "300": {
            video: "H264 MPEG-4 AVC,  357 kb/s, 384x216, 25fps, 16:9",
            index: 4
          }
        },
        NINATEKA: {
          def: {
            video: "H264 MPEG-4 AVC,  900 kb/s, 640x360, 25fps, 16:9",
            index: 1
          }
        },
        CDA: {
      ...
      resultUrlParams: function(input, template) {
        ...
        $.each(input, function(key, value) {
          template = template.replace(
            new RegExp(config.urlParamPattern + key, "g"),
            value
          );
          urlParams[key] = value;
        });
      ...
      resolveUrlParts: function(partIndex) {
        if (this.urlTemplateParts.length) {
          return this.urlTemplate.replace(
            config.urlPartPattern,
            this.urlTemplateParts[partIndex]
          );
        }
  ...
  var Notification = (function(Notification) {
    var create = function(title, bodyContent, special) {
      ...
      var content = $("<div>")
        .addClass("toast notification" + specialContentClasses)
        .attr("role", "alert")
        .attr("aria-live", "assertive")
        .attr("aria-atomic", "true")
        .attr("name", special ? "special" : "normal")
        .attr("data-delay", "5000");
      var header = $("<div>").addClass(
        "toast-header special-color-dark white-text"
      );
      var warnIcon = $("<i>").addClass("fas fa-exclamation-triangle pr-2");
      var notificationTitle = $("<strong>")
        .addClass("mr-auto")
        .text(title);
      var time = $("<small>").text(new Date().toLocaleTimeString());
      var close = $("<button>")
        .attr("type", "button")
        .addClass("ml-2 mb-1 close white-text")
      ...
      header
        ...
        .append(close);
      var body = $("<div>")
        .addClass("toast-body notification-body")
        .append(bodyContent);
  ...
  var PluginSettingsDetector = (function(PluginSettingsDetector) {
    var prepareWarningNotification = function(w) {
      var bodyContent = $("<div>")
        .append(
          "Twój dodatek ma nieprawidłowe ustawienia, przez co nie możesz korzystać z opcji "
        )
        .append(
          "bezpośredniego pobierania plików. Możesz skorygować je w następujący sposób:"
        );
      var list = $("<ol>")
        .addClass("m-0")
        .append(
          $("<li>").text(
            "Otwórz Panel sterowania Tampermonkey i kliknij ustawienia."
          )
        )
        .append($("<li>").text("Ogólne > Tryb konfiguracji > Expert"))
        .append(
          $("<li>").text("Pobieranie BETA > Tryb pobierania > API przeglądarki")
        )
        .append(
          $("<li>").text(
            "Zapisz ustawienia, a jeżeli przeglądarka zapyta o możliwość zarządzania" +
              " pobieranymi plikami, należy się zgodzić"
          )
        );
      bodyContent.append(list).append(createButton(w));
      var options = {
        title: "Wykryto problem",
        content: bodyContent,
        special: true
      };
    ...
    var createButton = function(w) {
      return $("<button>")
        ...
        .append($("<i>").addClass("fas pr-1 fa-window-close"))
        .append("Nie pokazuj więcej")
        .click(function() {
          var rootElement = $(w.document.body);
  ...
  var DomTamper = (function(DomTamper) {
    ...
    var createLinks = function(w, additionalClass) {
      var links = [
        {
          url:
            "https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=RWX4EUR77CMKU",
          icon: "fa-hand-holding-usd",
          tooltip: "dotacje"
        },
        {
          url:
            "https://greasyfork.org/pl/scripts/6049-skrypt-umo%C5%BCliwiaj%C4%85cy-pobieranie-" +
    ...
    DomTamper.handleError = function(exception, w) {
      ...
      pageContent.append(
        createLinks(
          w,
          errorData.type === "error" ? "btn-danger" : "special-color white-text"
        )
      );
    ...
    var getErrorData = function(exception) {
      ...
      if (exception.error) {
        message = exception.error.template
          .apply(this, exception.templateParams)
          .replace(/\n/g, "<br/>");
        caption = exception.error.caption;
        type =
          exception.error.type !== undefined ? exception.error.type : "error";
      }
    ...
    var linkify = function(text) {
      ...
      return text.replace(linkDetectionRegex, function(url) {
        return (
          '<u><a class="text-white" href="' + url + '">' + url + "</a></u>"
        );
      });
    };
    ...
    var createErrorContent = function(errorData) {
      ...
      var cardBody = $("<div>")
        ...
        .append(
          $("<h5>")
            .addClass("card-title")
            .text(errorData.caption)
        )
        .append(
          $("<div>")
            .addClass("card-text text-white mb-3")
            .append(errorData.message)
        )
        .append(
          $("<div>")
            .addClass("card-text text-white")
            .append("Informacje o systemie: ")
            .append(platform.description)
        )
        .append(
          $("<div>")
            .addClass("card-text text-white")
            .append("Wersja pluginu: ")
            .append(GM_info.version)
        )
        .append(
          $("<div>")
            .addClass("card-text text-white")
            .append("Wersja skryptu: ")
            .append(GM_info.script.version)
        );
    ...
    DomTamper.createButton = function(properties) {
      properties.observer
        .get()
        .find("#" + properties.button.id)
        .remove();
      var button = $("<input>")
        .attr("id", properties.button.id)
        .attr("type", "button")
        .attr("style", properties.button.style)
        .attr("value", "Pobierz video")
        .addClass(properties.button.class);
    ...
    var createLoaderContent = function() {
      ...
      var cardHeader = $("<div>")
        .addClass("card-header")
        .text("Poczekaj trwa wczytywanie danych...");
      var cardBody = $("<div>").addClass("card-body");
      var bodyContainer = $("<div>").addClass(
        "d-flex justify-content-center m-3"
      );
      var spinner = $("<div>")
        .addClass("spinner-border spinner-size")
        .attr("role", "status")
        .append(
          $("<span>")
            .addClass("sr-only")
    ...
    var createNotificationContainer = function() {
      return $("<div>")
        .attr("id", "notification-container")
  ...
  var Accordion = (function(Accordion) {
    Accordion.create = function(w, data) {
      var mainCardTitle = $("<div>")
        .addClass("card-header")
        .text(data.title);

      var accordion = $("<div>")
        .addClass("accordion md-accordion")
        .attr("id", "accordion")
        .attr("role", "tablist")
    ...
    var createCard = function(data) {
      ...
      var icon = $("<i>")
        .addClass("fas")
        .addClass(data.card.icon)
        .addClass("pr-2");
      var badge = $("<span>")
        .addClass("badge mr-3 float-right")
        .addClass(badgeClass)
    ...
    var createCardContent = function(data) {
      var table = $("<table>").addClass(
        "table table-bordered table-striped btn-table"
      );
      var tbody = $("<tbody>");
      table.append(tbody);
    ...
    var createRow = function(data) {
      var actions = $("<td>")
        .attr("scope", "row")
        .addClass("action-row-" + data.actions.length);
    ...
    var itemExist = function(data, info) {
      return (
        data.item.hasOwnProperty(info.name) && data.item[info.name] != null
      );
    };
    ...
    var buttonActions = function(w) {
      getButton(w, ".fa-clone").click(function() {
        copyActionClick($(this), w);
      });
      getButton(w, ".fa-film").click(function() {
        openActionClick($(this), w);
      });
      getButton(w, ".fa-download").click(function() {
        downloadActionClick($(this), w);
      });
    };
    ...
    var downloadActionClick = function(element, w) {
      var options = {
        ...
        content: element.attr("data-title")
      };
  ...
  var Executor = (function(Executor) {
    ...
    var executeAsync = function(service, setup, options, w) {
      ...
      var requestParams = {
        ...
        onerror: function(data) {
          DomTamper.handleError(
            new Exception(config.error.call, exceptionParams),
            w
          );
        },
        ontimeout: function() {
          DomTamper.handleError(
            new Exception(config.error.timeout, exceptionParams),
            w
          );
        }
      };
    ...
    var retryPossible = function(step, options, status) {
      return (
        step.retryErrorCodes.indexOf(status) >= 0 &&
        step.urlTemplateParts[options.retries++]
      );
    };
    ...
    var logStepInfo = function(options, setup) {
      ...
      var stepParams = $.isEmptyObject(setup.methodParam())
        ? ""
        : JSON.stringify(setup.methodParam());
      var params = [
        "color:green",
        options.retries + 1,
        "color:black",
        ...
        step,
        "color:red",
        setup.isRemote ? setup.method : "---",
        "color:black;font-weight: bold",
        setup.resolveUrl.url,
        "color:magenta",
        stepParams
      ];
    ...
    var setupStep = function(service, options) {
      ...
      setup.resolveUrl = currentStep.resolveUrl(
        options.urlParams,
        options.retries
      );
      return setup;
    ...
    var callback = function(service, options, w) {
      try {
        ...
        if (pushStep(service, options) || pushChain(service, options)) {
          return Promise.resolve().then(Executor.chain(service, options, w));
        } else {
          return Promise.resolve().then(service.onDone(options.results, w));
        }
      } catch (e) {
      ...
      cardsData: {
        ...
        cards: {
          ...
          subtitles: {
            ...
            actions: [{ label: "Pobierz", icon: "fa-download" }]
          }
        }
      },
      asyncChains: {
  ...
  var Detector = function(conf) {
    ...
    this.observe = function() {
      ...
      if (observer.exist()) {
        ...
        $(observer.anchor).observe(observer.mode, observer.selector, function(
          record
        ) {
          logObservation();
          configuration.successCallback();
  ...
  var Common = (function(Common) {
    Common.grabIplaSubtitlesData = function(data) {
      var items = [];
      var subtitles =
        (((data.result || {}).mediaItem || {}).displayInfo || {}).subtitles ||
        [];
      ...
      if (files.length) {
        ...
        return {
          title:
            ...
            (info.subtitle != null ? " " + info.subtitle : ""),
          cards: {
            videos: { items: items },
  ...
  var VOD_TVP = function() {
    var properties = new Configurator({
      ...
      asyncChains: {
        videos: [
          new Step({
            urlTemplate:
              "https://tvp.pl/pub/stat/videofileinfo?video_id=#videoId",
            beforeStep: function(input) {
              return idParser();
            }
          }),
          new Step({
            urlTemplate:
              "https://vod.tvp.pl/sess/TVPlayer2/api.php?id=#videoId&@method=getTvpConfig" +
              "&@callback=callback",
            responseType: "jsonp",
    ...
    var getRealVideoId = function(json) {
      var videoId =
        json.copy_of_object_id !== undefined
          ? json.copy_of_object_id
          : json.video_id;
      return {
        videoId: videoId
      };
  ...
  var TVN = function() {
    var properties = new Configurator({
      ...
      asyncChains: {
        videos: [
          new Step({
            urlTemplate:
              "http://player.pl/api/?platform=ConnectedTV&terminal=Panasonic&format=json" +
    ...
    var grabVideoData = function(data) {
      ...
      if (
        main.video_content_license_type !== "WIDEVINE" &&
        video_content &&
        video_content.length > 0
      ) {
    ...
    var getTitle = function(data) {
      var episode = data.item.episode
        ? "E" + Tool.pad(data.item.episode, 2)
        : "";
      var season =
        data.item.season != null ? "S" + Tool.pad(data.item.season, 2) : "";
      var serie_title =
        data.item.serie_title != null ? data.item.serie_title : "";
  ...
  var IPLA = function() {
    var properties = new Configurator({
      observer: {
        anchor: "app-root",
        selector:
          "div.player-wrapper, div.promo-box:visible," +
      ...
      asyncChains: {
        videos: [
          new Step({
            urlTemplateParts: ["ua=www_iplatv_html5/12345", "ua=mipla_ios/122"],
            urlTemplate:
              "https://getmedia.redefine.pl/vods/get_vod/?cpid=1&~&media_id=#videoId",
            retryErrorCodes: [404],
            beforeStep: function(input) {
    ...
    var grabVideoIdFromWatchingNowElement = function() {
      return matchingId(
        $("div.vod-image-wrapper__overlay")
          .closest("a")
          .attr("href"),
        grabVideoIdFromHtmlElement
      );
    };

    var grabVideoIdFromHtmlElement = function() {
      var frameSrc = $("app-commercial-wallpaper iframe:first-child").attr(
        "src"
      );
  ...
  var VOD = function() {
    var properties = new Configurator({
      ...
      asyncChains: {
        videos: [
          new Step({
            urlTemplate:
              "https://player-api.dreamlab.pl/?body[id]=#videoId&body[jsonrpc]=2.0" +
    ...
    var grabVideoData = function(data) {
      ...
      var subtitlesItems = [];
      var video =
        (((data.result || new Array())[0] || {}).formats || {}).wideo || {};
      var meta = ((data.result || new Array())[0] || {}).meta || {};
      var subtitles = meta.subtitles || [];
      var videoData =
        video["mp4-uhd"] && video["mp4-uhd"].length > 0
          ? video["mp4-uhd"]
          : video["mp4"];
      if (videoData && videoData.length > 0) {
        videoData.forEach(function(value) {
          var videoDesc =
            value.vertical_resolution + ", " + value.video_bitrate;
          items.push(
            Tool.mapDescription({
              source: "VOD",
    ...
    var workWithSubService = function() {
      ...
      var observer = Common.createObserver(
        "div.pulsembed_embed",
        frameSelector
      );
  ...
  var VOD_IPLA = function() {
    var properties = new Configurator({
      ...
      asyncChains: {
        videos: [
          new Step({
            urlTemplate:
              "https://distro.redefine.pl/partner_api/v1/2yRS5K/media/#media_id/vod/player_data?" +
    ...
    var grabVideoData = function(data) {
      ...
      var mediaSources =
        ((data.mediaItem || {}).playback || {}).mediaSources || {};
    ...
    var getJson = function() {
      var match = $("script:not(:empty)")
        .text()
        .match(/(window\.CP\.embedSetup\()(.*)\);/);
      if (match) {
  ...
  var CDA = function() {
    ...
    var prepareResult = function(url, w) {
      ...
      cardsData.title =
        title.length > 0 ? title.attr("content").trim() : "brak danych";
    ...
    var clickButton = function() {
      ...
      try {
        ...
        if (sources.length > 0) {
          ...
          var scripts = $('script[type="text/javascript"]').filter(
            ":not([src])"
          );
          for (var i = 0; i < scripts.length; i++) {
            var match = $(scripts[i])
              .text()
              .match(/fn_\S+\(playerOptionsWithMainSource,\s*\d+\)\.sources/g);
            if (match && match[0]) {
  ...
  var ARTE = function() {
    var properties = new Configurator({
      ...
      asyncChains: {
        videos: [
          new Step({
            urlTemplate:
              "https://api.arte.tv/api/player/v1/config/#langCode/#videoId",
            beforeStep: function(input) {
              return idParser();
            },
            afterStep: function(output) {
      ...
      formatter: function(data) {
        ...
        data.cards["videos"].items.sort(function(a, b) {
          var aLangOrder = sortingOrder[a.langCode]
              ? sortingOrder[a.langCode]
              : -1,
            bLangOrder = sortingOrder[b.langCode]
              ? sortingOrder[b.langCode]
              : -1;
    ...
    var grabVideoData = function(data) {
      var items = [];
      var title =
        (((data || {}).videoJsonPlayer || {}).eStat || {}).streamName || "";
      ...
      if (streams) {
        Object.keys(streams)
          ...
          .forEach(function(k) {
            ...
            var videoDesc =
              stream.width + "x" + stream.height + ", " + stream.bitrate;
            items.push(
              Tool.mapDescription({
                source: "ARTE",
                key: stream.bitrate,
    ...
    var properties = new Configurator({
      ...
      asyncChains: {
        videos: [
          ...
          new Step({
            urlTemplate:
              "https://api-trwam.app.insysgo.pl/v1/Player/AcquireContent?platformCodename=www&" +
              "codename=#codename",
            afterStep: function(output) {
              return grabVideoData(output);
            }
  ...
  var Starter = (function(Starter) {
    var sources = [
      {
        objectName: "VOD_TVP",
        urlPattern: /^https:\/\/vod\.tvp\.pl\/video\/|^https?:\/\/.*\.tvp.pl\/sess\/TVPlayer2\/embed.*$/
      },
      {
        objectName: "CYF_TVP",
        urlPattern: /^https:\/\/cyfrowa\.tvp\.pl\/video\//
      },
      {
        objectName: "TVN",
        urlPattern: /^https:\/\/(?:w{3}\.)?(?:tvn)?player\.pl\//
      },
      { objectName: "CDA", urlPattern: /^https:\/\/.*\.cda\.pl\// },
      { objectName: "VOD", urlPattern: /^https:\/\/vod.pl\// },
      {
        objectName: "VOD_IPLA",
        urlPattern: /^https:\/\/partner\.ipla\.tv\/embed\/|^https:\/\/.*\.redcdn.pl\/file\/o2\/redefine\/partner\//
      },
      ...
      {
        objectName: "ARTE",
        urlPattern: /^https:\/\/www.arte.tv\/.*\/videos\//
      },
      { objectName: "VOD_FRAME", urlPattern: /^https:\/\/pulsembed\.eu\// },
      {
        objectName: "TV_TRWAM",
        urlPattern: /^https:\/\/tv-trwam.pl\/local-vods\//
      }
    ];
